...
const packId='models-1000-20260921',target=200,ua='LearningObservatory/0.3 educational CC0 collection';
const root=runtimeUrl('samples/models-1000/'),delivery=sourceUrl('deliverables/models-20260921/');
...
await save(runtimeUrl('output/models-1000-import.json'),manifest);await save(new URL('manifest.json',delivery),manifest);
