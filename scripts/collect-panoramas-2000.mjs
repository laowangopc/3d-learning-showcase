...
const target=2000, packId='poly-panoramas-2000-20260921';
const ua='LearningObservatory/0.3 educational CC0 collection';
const license='https://polyhaven.com/license';
const root=runtimeUrl('materials-2000/poly-panoramas/');
const delivery=root;
...
const baselineUrl=new URL('baseline.json',root);
...
await save(new URL('import-results.json',root),manifest);
