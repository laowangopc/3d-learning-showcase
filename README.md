...
以下是访客模式下的真实界面截图，展示的是观察体验；截图中的教学素材文件**不随本仓库发布**。[查看截图中的素材来源与许可](docs/screenshots/README.md)。

### 3D 模型观察

旋转、缩放显微镜模型，左侧用缩略图筛选资源，右侧查看来源与许可。

![3D 模型观察界面：显微镜、资源缩略图和来源许可](docs/screenshots/3d-model-microscope.png)

### 720 全景观察

在博物馆全景中环顾现场，并查看观察提示与原始素材出处。

![720 全景观察界面：自然历史博物馆展厅](docs/screenshots/panorama-hall-of-mammals.png)

### 人体器官示例

人体解剖是众多教学主题之一；心脏模型同样提供交互观察、署名和教学边界提示。

![人体器官观察界面：心脏三维模型及来源说明](docs/screenshots/organ-heart.png)
